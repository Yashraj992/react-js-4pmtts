...
export default function Navbar() {
  return (
    <div>
      <nav className='nav navbar container mt-2 navbar-md-expand'>
        ...
        <Link to="/reservation" className='no-underline text-black'><button className='hover:bg-pink-200 p-2 border-1 border-black rounded font-semibold'>Make a Reservation</button></Link>
      </nav>
    </div>
  )
}
